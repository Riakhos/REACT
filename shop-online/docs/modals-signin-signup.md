...
>**Objectif** : Permettre à l'utilisateur de se connecter ou de créer un compte via des modals (fenêtres pop-up).
...
## Partie 3 : Contraintes de validation détaillées
...
## Partie 4 : Création d'une modal

### Exemple d'ouverture/fermeture de modals
```tsx
...
## Partie 5 : Validation avec react-hook-form
```tsx
...
## Partie 6 : Utilisation de navigate pour la navigation entre les modals et les pages

Pour une expérience utilisateur fluide, la navigation entre les pages (ouverture de la page d'inscription, mot de passe oublié, etc.) se fait avec le hook `useNavigate` de React Router :
